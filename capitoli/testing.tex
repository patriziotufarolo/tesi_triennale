...
%ELIA: Cerca di evitare l'uso della parola development %PATRIZIO: che metto?
...
%ELIA non è meglio un a capo dopo il titolo di paragrafo? %PATRIZIO: è lo stile di latex poi guardo l'effetto finale
...
%ELIA: inventate qualcosa, tagliala, spezzala in due, ma 'sta figura deve da esse dritta!!!! By the way, avendola presa probabilmente da un'altro libro/tesi, c'è una doppia didascalia, e ciò è osceno :)
%PAT: si l ho presa dallo standard anche li è messa cosi... è problematica perche se la metto dritta se vede tutto troppo piccolo. se la taglio non si capisce piu ora vedo come gestirla nel caso la tolgo e la metto in appendice boh tanto non è molto importante
\begin{figure}[H]
\centering
\makebox[\textwidth]{
\includegraphics[width=15cm]{immagini/VerAndVal.png}
}
...
\end{figure}
La Figura 1.2 mostra chiaramente come il testing si inserisce in un contesto aziendale stratificato.
